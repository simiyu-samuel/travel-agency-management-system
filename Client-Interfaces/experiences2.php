    ...
    <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <nav>
        <ul class="flex space-x-6 font-semibold text-sm md:text-base">
          ...
          <li><a href="../Client-Interfaces/client-dashboard-home.php" class="hover:text-green-700 transition">DASHBOARD</a></li>
          <li><a href="#" class="text-green-700 border-b-2 border-green-700">EXPERIENCES</a></li>
          <li><a href="contact-us2.php" class="hover:text-green-700 transition">CONTACT US</a></li>
