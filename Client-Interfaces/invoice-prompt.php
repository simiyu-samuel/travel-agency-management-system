...
<body class="bg-gray-100 font-[Poppins] min-h-screen">
  ...
  <div class="flex min-h-screen">
    ...
    <nav class="w-64 bg-green-800 text-white p-6 flex flex-col space-y-4">
      ...
      <a href="#" class="bg-green-900 p-2 rounded font-semibold">Invoices</a>
    ...
    <main class="flex-1 p-8">
      <h2 class="text-2xl font-semibold text-gray-800 mb-6">Invoice Prompt</h2>
      ...
      <div class="bg-white rounded-lg shadow p-8 max-w-md mx-auto">
        ...
        <p class="mb-6 text-gray-700 font-medium">
          Kindly enter your <strong>client code</strong> to view your invoices:
        </p>

        <form action="client-invoices.php" method="post" class="space-y-6">
          <div>
