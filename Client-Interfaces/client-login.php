...
<head>
  ...
  <title>Arnachy Adventures | Client Login</title>
...
<body class="min-h-screen bg-cover bg-center" style="background-image: url('Images/maasai-women.jpg')">
  <div class="flex items-center justify-center min-h-screen bg-overlay px-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 md:p-10">
      ...
      <form action="../Processes/login-process.php" method="post" class="space-y-5">
        <div>
        ...
        <button type="submit" name="register-button" class="w-full bg-green-700 text-white py-2 px-4 rounded-lg hover:bg-green-800 transition duration-300">Log In</button>
        <div class="text-center text-sm mt-4">
          <p>Don't have an account? <a href="client-registration.php" class="text-green-700 hover:underline">Sign up</a></p>
