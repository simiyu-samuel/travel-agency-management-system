...
<head>
  ...
  <title>Arnachy Adventures | Agent Login</title>
...
<body class="min-h-screen bg-cover bg-center" style="background-image: url('../Index/Images/passport.jpg')">
  <div class="flex items-center justify-center min-h-screen bg-overlay px-4">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 md:p-10">
      <h2 class="text-3xl font-bold text-center text-green-700 mb-6">Agent Login</h2>
      <form action="../Processes/agent-login-process.php" method="post" class="space-y-5">
        <div>
          <label for="email" class="block mb-1 font-semibold text-gray-700">Email Address</label>
          <input type="text" id="email" name="agent_email" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-600 focus:outline-none"/>
        </div>
        <div>
        ...
        <div class="text-center text-sm mt-4">
          <p>Administrator? <a href="../Admin-Interface/admin-login.php" class="text-green-700 hover:underline">Log in here</a></p>
